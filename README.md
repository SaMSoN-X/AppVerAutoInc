...
<a href="https://habr.com/ru/articles/237585/">Хабр: Полуавтоматическое инкрементирование версии проекта при работе с GIT в Visual Studio.</a>
           ...
           Для моих задач не нужно использовать Git - необходим простой инкремент 
       при каждой пересборке проекта, поэтому проект Helldar'a упрощён до simple.
   
       Мне было бы крайне приято, если кому-то будет полезно.
